!(function (t) {
    ...
    (t.fn.sectionPosition = function (e, s) {
      t(this).each(function () {
        ...
        (a = Math.floor(l.height() / 2)),
          ...
          "top-half" === i
            ? (t(n).css("padding-bottom", r + a + "px"),
              l.css("margin-top", "-" + a + "px"))
            : "bottom-half" === i &&
              (t(n).css("padding-top", o + a + "px"),
    ...
    (t.fn.sectionSpace = function (e, s) {
      t(this).each(function () {
        ...
        (a = c.attr(e)),
          (i = c.attr(s)),
          (n = c.data("margin-top")),
          (o = c.data("margin-bottom")),
          (r = u(t(i).css("padding-top"))),
          (l = u(t(i).css("padding-bottom"))),
          "margin-top" === a
            ? (t(i).css("padding-bottom", l + u(n) + "px"),
              c
                .css("margin-top", "-" + u(n) + "px")
                .css({ position: "relative", "z-index": "3" }))
            : "margin-bottom" === a &&
              (t(i).css("padding-top", r + u(o) + "px"),
              c
                .css("margin-bottom", "-" + u(o) + "px")
                .css({ position: "relative", "z-index": "3" }));
      });
    });
  function f() {
  ...
  t("[data-sec-space]").length &&
    ...
    (t.fn.thTab = function (e) {
      ...
      t(this).each(function () {
        ...
        if (
          (a.on("click", function (e) {
            ...
            a.addClass("active").siblings().removeClass("active"),
              s.sliderTab
                ? t(n).slick("slickGoTo", a.data("slide-go-to"))
                : r();
          }),
          s.sliderTab)
        ) {
          ...
          a.each(function () {
            ...
            a.attr("data-slide-go-to", o),
              ...
              a.hasClass("active") &&
                t(n).slick("slickGoTo", a.data("slide-go-to")),
              t(n).on("beforeChange", function (t, a, i, n) {
                e
        ...
        function r() {
          var n = e.find(s.tabButton + ".active"),
            o = n.css("height"),
            r = n.css("width"),
            l = n.position().top + "px",
          ...
          i.get(0).style.setProperty("--height-set", o),
            ...
            t(a).first().position().left == n.position().left
              ? i.addClass("start").removeClass("center").removeClass("end")
              : t(a).last().position().left == n.position().left
    ...
    (t.fn.shapeMockup = function () {
      t(this).each(function () {
        var e = t(this),
          ...
          i = e.data("bottom"),
          n = e.data("left");
        e.css({ top: s, right: a, bottom: i, left: n })
          .removeAttr("data-top")
  ...
  function v(e) {
    var s = e.touches ? e.touches[0].clientX : e.clientX,
      ...
      o = -(s - i) / (i / 1) - 1,
      r = -(a - n) / (n / 1) - 1;
    TweenMax.to(t(".banner-anime-img"), 1, { top: r + "%", left: o + "%" });
  }
  function w(e, s, a, i) {
    var n = e.text().split(s),
      o = "";
    n.length &&
      (t(n).each(function (t, e) {
        o += '<span class="' + a + (t + 1) + '">' + e + "</span>" + i;
      }),
      e.empty().append(o));
  }
  ...
  var b = {
    ...
    lines: function () {
      return this.each(function () {
        ...
        w(t(this).children("br").replaceWith(e).end(), e, "line", "");
      });
    },
  };
  (t.fn.lettering = function (e) {
    ...
    t(".about-anime").lettering(),
    t("#serviceAccordion").on("show.bs.collapse", function (e) {
      var s = t(e.target).closest(".accordion-item").index();
